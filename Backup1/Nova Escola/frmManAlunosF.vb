    ...
    Private Sub frmManBoletim_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Try
                ...
                Dim sql8
                sql8 = "SELECT * FROM " & BD_OK & ".boletim WHERE cod_boletim='" & lbNF.Text & "'"
            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N") Then
                ...
                Try
                    ...
                    Try
                        ...
                        SQL3 = "UPDATE " & BD_OK & ".boletim SET M='" & tbMedia.Text & "', S='" & tbSN.Text & "' WHERE cod_boletim='" & lbNF.Text & "' AND nro_aluno='" & lbCodigo.Value & "';"
                        atualizaMySQL(SQL3)
                        ...
                        SQL2 = "UPDATE " & BD_OK & ".boletim SET M='" & tbMedia.Text & "', S='" & tbSN.Text & "' WHERE cod_boletim=" & lbNF.Text & " AND nro_aluno=" & lbCodigo.Value
                        atualizaMySQL(SQL2)
