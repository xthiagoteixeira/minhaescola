...
Public Class frmManBoletim234
    ...
    Private Sub frmManBoletim_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Try
                ...
                Dim sql8
                sql8 = "SELECT * FROM boletim WHERE cod_boletim='" & lbNF.Text & "'"
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdicionar.Click
        ...
        '################## SE FOR AVALIACAO FINAL
        If lBoletim.Text = "2AF" Or lBoletim.Text = "4AF" Then
            If Not IsNumeric(tbSN.Text) Then
                    ...
                    If (IsNumeric(tbAC.Text) = True) Then
                        ...
                        Try
                            ...
                            Try
                                ...
                                SQL = "SELECT * FROM " & BD_OK & ".boletim WHERE cod_boletim='" & lbNF.Text & "' ORDER BY nro_aluno DESC"
                                ...
                                SQL5 = "UPDATE " & BD_OK & ".boletim SET F=" & tbFaltas.Text & ", AC=" & tbAC.Text & ", M='" & tbMedia.Text & "', S='" & tbSN.Text & "', porcentagem=" & porcentagem & " WHERE cod_boletim=" & lbNF.Text & " AND nro_aluno=" & lbCodigo.Value
                                atualizaMySQL(SQL5)
                                ...
                                SQL4 = "SELECT * FROM " & BD_OK & ".boletim WHERE nro_aluno=" & lbCodigo.Value & " AND cod_boletim=" & lbNF.Text
                                myCommand4.Connection = conn
                                myCommand4.CommandText = SQL4
                                myAdapter4.SelectCommand = myCommand4
                                myAdapter4.Fill(myData4)
        ...
        If lBoletim.Text = "4AF" Or lBoletim.Text = "2AF" Then
            tbAC.Text = "0"
            tbFaltas.Text = "0"
            tbAC.Enabled = False
            tbFaltas.Enabled = False
