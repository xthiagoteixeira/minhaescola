...
Public Class frmManACP
    ...
    Private Sub btAdicionar_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdicionar.Click
        ...
        Else
            ...
            MsgBox("Deseja excluir o boletim " & testeAF & "o. Bimestre - Turma: " & cbTurma.Text & " - Disciplina: " & cbDisciplina.Text & " ?", MsgBoxStyle.YesNo, "Atenção!")
                    ...
                    Try
                        ...
                        Try
                            ...
                            Try
                                ...
                                SQL7 = "DELETE FROM " & BD_OK & ".notasfreq WHERE disciplina=" & nrodisciplina & " AND turma=" & nroturma & " AND anovigente=" & tAno.Value & " AND cod_bimestre='" & testeAF & "'"
                ...
                Else
                    ...
                    Try
                        ...
                        Try
                            ...
                            SQL7 = "DELETE FROM " & BD_OK & ".notasfreq WHERE turma=" & nroturma & " AND anovigente=" & tAno.Value & " AND cod_bimestre='" & testeAF & "'"
                            myCommand7.Connection = conn
                            myCommand7.CommandText = SQL7
                            myAdapter7.SelectCommand = myCommand7
                            myAdapter7.Fill(myData7)
    ...
    Private Sub CheckBoxX1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbTodas.CheckedChanged
