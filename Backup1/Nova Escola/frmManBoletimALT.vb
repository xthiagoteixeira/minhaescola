...
Public Class frmManBoletimALT
    ...
    Private Sub btAdicionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdicionar.Click
        ...
        Else
            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N" Or tbSN.Text = "1" Or tbSN.Text = "3" Or tbSN.Text = "4") Then
                If Not (IsNumeric(tbFaltas.Text) = True) Then
    ...
    Private Sub DGBoletim_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DGBoletim.MouseUp
        ...
        If r("Avaliação") = "11" Then
            tbMedia.Text = "TR"
        ElseIf r("Avaliação") = "12" Then
            tbMedia.Text = "AB"
        ElseIf r("Avaliação") = "13" Then
            tbMedia.Text = "LS"
        ElseIf r("Avaliação") = "14" Then
            tbMedia.Text = "LG"
        ElseIf r("Avaliação") = "15" Then
            tbMedia.Text = "RE"
        ElseIf r("Avaliação") = "16" Then
            tbMedia.Text = "FA"
        ElseIf r("Avaliação") = "17" Then
            tbMedia.Text = "DI"
        ElseIf r("Avaliação") = "18" Then
            tbMedia.Text = "NA"
        ElseIf r("Avaliação") = "19" Then
            tbMedia.Text = "NC"
        Else
    ...
    Private Sub DGBoletim_Navigate(ByVal sender As System.Object, ByVal ne As System.Windows.Forms.NavigateEventArgs) Handles DGBoletim.Navigate
