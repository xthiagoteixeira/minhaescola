...
Public Class frmCadBoletim
    ...
    Dim testeMedia, testeFalta

    Private Sub frmCadBoletim_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        tbMedia.Focus()
        ...
        Try
            ...
            Try
                ...
                If travaC.Text = 1 Then
                    ...
                    SQL7 = "SELECT * FROM boletim WHERE cod_boletim=" & lbBoletim.Text & " ORDER BY nro_aluno DESC"
    ...
    Private Sub tbFaltas_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles tbFaltas.LostFocus
        ...
        If (tbFaltas.Text = "TR" Or tbFaltas.Text = "Tr" Or tbFaltas.Text = "tr") Then
            testeFalta = 11

        ElseIf (tbFaltas.Text = "AB" Or tbFaltas.Text = "Ab" Or tbFaltas.Text = "ab") Then
            testeFalta = 12

        ElseIf (tbFaltas.Text = "LS" Or tbFaltas.Text = "Ls" Or tbFaltas.Text = "ls") Then
            testeFalta = 13

        ElseIf (tbFaltas.Text = "LG" Or tbFaltas.Text = "Lg" Or tbFaltas.Text = "lg") Then
            testeFalta = 14

        ElseIf (tbFaltas.Text = "RE" Or tbFaltas.Text = "Re" Or tbFaltas.Text = "re") Then
            testeFalta = 15

        ElseIf (tbFaltas.Text = "FA" Or tbFaltas.Text = "Fa" Or tbFaltas.Text = "fa") Then
            testeFalta = 16

        ElseIf (tbFaltas.Text = "DI" Or tbFaltas.Text = "Di" Or tbFaltas.Text = "di") Then
            testeFalta = 17

        ElseIf (tbFaltas.Text = "NA" Or tbFaltas.Text = "Na" Or tbFaltas.Text = "na") Then
            testeFalta = 18

        ElseIf (tbFaltas.Text = "NC" Or tbFaltas.Text = "Nc" Or tbFaltas.Text = "nc") Then
            testeFalta = 19

        Else

            If Not IsNumeric(tbFaltas.Text) Then
                testeFalta = 98

            Else
                testeFalta = tbFaltas.Text
    ...
    Private Sub ButtonX2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btVoltar.Click
        ...
        fManBoletimALT.btAdicionar.Visible = True
                    ...
                    Else
                        ...
                        Try
                            ...
                            Try
                                ...
                                End If
                                SQL3 = "INSERT INTO " & BD_OK & ".boletim (cod_boletim, nro_aluno, M, F, S, porcentagem) values (" & lbBoletim.Text & "," & lbCodigo.Text & ", '" & tbMedia.Text & "', " & tbFaltas.Text & ", '" & tbSN.Text & "', '" & porcentagem & "')"
                                atualizaMySQL(SQL3)
