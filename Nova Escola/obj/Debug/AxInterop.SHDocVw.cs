...
[assembly: System.Windows.Forms.AxHost.TypeLibraryTimeStamp("06/08/2018 02:41:41")]
...
namespace AxSHDocVw {
    ...
    public class AxWebBrowser : System.Windows.Forms.AxHost {
        ...
        public virtual object GetProperty(string property) {
            ...
            object returnValue = ((object)(this.ocx.GetProperty(property)));
            return returnValue;
        }
        ...
        public virtual SHDocVw.OLECMDF QueryStatusWB(SHDocVw.OLECMDID cmdID) {
            ...
            SHDocVw.OLECMDF returnValue = ((SHDocVw.OLECMDF)(this.ocx.QueryStatusWB(cmdID)));
            return returnValue;
        }
        ...
        internal void RaiseOnBeforeScriptExecute(object sender, DWebBrowserEvents2_BeforeScriptExecuteEvent e) {
            if ((this.BeforeScriptExecute != null)) {
                this.BeforeScriptExecute(sender, e);
            }
        }
        
        internal void RaiseOnWebWorkerStarted(object sender, DWebBrowserEvents2_WebWorkerStartedEvent e) {
            if ((this.WebWorkerStarted != null)) {
                this.WebWorkerStarted(sender, e);
            }
        }
        
        internal void RaiseOnWebWorkerFinsihed(object sender, DWebBrowserEvents2_WebWorkerFinsihedEvent e) {
            if ((this.WebWorkerFinsihed != null)) {
                this.WebWorkerFinsihed(sender, e);
            }
        }
    }
    ...
    public class DWebBrowserEvents2_FileDownloadEvent {
        ...
        public DWebBrowserEvents2_FileDownloadEvent(bool activeDocument, bool cancel) {
    ...
    public delegate void DWebBrowserEvents2_SetPhishingFilterStatusEventHandler(object sender, DWebBrowserEvents2_SetPhishingFilterStatusEvent e);
    
    public class DWebBrowserEvents2_SetPhishingFilterStatusEvent {
        
        public int phishingFilterStatus;
        
        public DWebBrowserEvents2_SetPhishingFilterStatusEvent(int phishingFilterStatus) {
            this.phishingFilterStatus = phishingFilterStatus;
        }
    }
    
    public delegate void DWebBrowserEvents2_WindowStateChangedEventHandler(object sender, DWebBrowserEvents2_WindowStateChangedEvent e);
    
    public class DWebBrowserEvents2_WindowStateChangedEvent {
        
        public uint dwWindowStateFlags;
        
        public uint dwValidFlagsMask;
        
        public DWebBrowserEvents2_WindowStateChangedEvent(uint dwWindowStateFlags, uint dwValidFlagsMask) {
            this.dwWindowStateFlags = dwWindowStateFlags;
            this.dwValidFlagsMask = dwValidFlagsMask;
        }
    }
    
    public delegate void DWebBrowserEvents2_NewProcessEventHandler(object sender, DWebBrowserEvents2_NewProcessEvent e);
    
    public class DWebBrowserEvents2_NewProcessEvent {
        
        public int lCauseFlag;
        
        public object pWB2;
        
        public bool cancel;
        
        public DWebBrowserEvents2_NewProcessEvent(int lCauseFlag, object pWB2, bool cancel) {
            this.lCauseFlag = lCauseFlag;
            this.pWB2 = pWB2;
            this.cancel = cancel;
        }
    }
    
    public delegate void DWebBrowserEvents2_ThirdPartyUrlBlockedEventHandler(object sender, DWebBrowserEvents2_ThirdPartyUrlBlockedEvent e);
    
    public class DWebBrowserEvents2_ThirdPartyUrlBlockedEvent {
        
        public object uRL;
        
        public uint dwCount;
        
        public DWebBrowserEvents2_ThirdPartyUrlBlockedEvent(object uRL, uint dwCount) {
            this.uRL = uRL;
            this.dwCount = dwCount;
        }
    }
    
    public delegate void DWebBrowserEvents2_RedirectXDomainBlockedEventHandler(object sender, DWebBrowserEvents2_RedirectXDomainBlockedEvent e);
    
    public class DWebBrowserEvents2_RedirectXDomainBlockedEvent {
        
        public object pDisp;
        
        public object startURL;
        ...
        public DWebBrowserEvents2_RedirectXDomainBlockedEvent(object pDisp, object startURL, object redirectURL, object frame, object statusCode) {
            this.pDisp = pDisp;
    ...
    public delegate void DWebBrowserEvents2_BeforeScriptExecuteEventHandler(object sender, DWebBrowserEvents2_BeforeScriptExecuteEvent e);
    
    public class DWebBrowserEvents2_BeforeScriptExecuteEvent {
        
        public object pDispWindow;
        
        public DWebBrowserEvents2_BeforeScriptExecuteEvent(object pDispWindow) {
            this.pDispWindow = pDispWindow;
        }
    }
    
    public delegate void DWebBrowserEvents2_WebWorkerStartedEventHandler(object sender, DWebBrowserEvents2_WebWorkerStartedEvent e);
    
    public class DWebBrowserEvents2_WebWorkerStartedEvent {
        
        public uint dwUniqueID;
        
        public string bstrWorkerLabel;
        
        public DWebBrowserEvents2_WebWorkerStartedEvent(uint dwUniqueID, string bstrWorkerLabel) {
            this.dwUniqueID = dwUniqueID;
            this.bstrWorkerLabel = bstrWorkerLabel;
        }
    }
    
    public delegate void DWebBrowserEvents2_WebWorkerFinsihedEventHandler(object sender, DWebBrowserEvents2_WebWorkerFinsihedEvent e);
    
    public class DWebBrowserEvents2_WebWorkerFinsihedEvent {
        
        public uint dwUniqueID;
        
        public DWebBrowserEvents2_WebWorkerFinsihedEvent(uint dwUniqueID) {
            this.dwUniqueID = dwUniqueID;
        }
    }
    ...
    public class AxWebBrowserEventMulticaster : SHDocVw.DWebBrowserEvents2 {
        ...
        public virtual void FileDownload(bool activeDocument, ref bool cancel) {
            DWebBrowserEvents2_FileDownloadEvent filedownloadEvent = new DWebBrowserEvents2_FileDownloadEvent(activeDocument, cancel);
        ...
        public virtual void SetPhishingFilterStatus(int phishingFilterStatus) {
            DWebBrowserEvents2_SetPhishingFilterStatusEvent setphishingfilterstatusEvent = new DWebBrowserEvents2_SetPhishingFilterStatusEvent(phishingFilterStatus);
            this.parent.RaiseOnSetPhishingFilterStatus(this.parent, setphishingfilterstatusEvent);
        }
        
        public virtual void WindowStateChanged(uint dwWindowStateFlags, uint dwValidFlagsMask) {
            DWebBrowserEvents2_WindowStateChangedEvent windowstatechangedEvent = new DWebBrowserEvents2_WindowStateChangedEvent(dwWindowStateFlags, dwValidFlagsMask);
            this.parent.RaiseOnWindowStateChanged(this.parent, windowstatechangedEvent);
        }
        
        public virtual void NewProcess(int lCauseFlag, object pWB2, ref bool cancel) {
            DWebBrowserEvents2_NewProcessEvent newprocessEvent = new DWebBrowserEvents2_NewProcessEvent(lCauseFlag, pWB2, cancel);
            this.parent.RaiseOnNewProcess(this.parent, newprocessEvent);
            cancel = newprocessEvent.cancel;
        }
        
        public virtual void ThirdPartyUrlBlocked(ref object uRL, uint dwCount) {
            DWebBrowserEvents2_ThirdPartyUrlBlockedEvent thirdpartyurlblockedEvent = new DWebBrowserEvents2_ThirdPartyUrlBlockedEvent(uRL, dwCount);
            this.parent.RaiseOnThirdPartyUrlBlocked(this.parent, thirdpartyurlblockedEvent);
            uRL = thirdpartyurlblockedEvent.uRL;
        }
        
        public virtual void RedirectXDomainBlocked(object pDisp, ref object startURL, ref object redirectURL, ref object frame, ref object statusCode) {
            DWebBrowserEvents2_RedirectXDomainBlockedEvent redirectxdomainblockedEvent = new DWebBrowserEvents2_RedirectXDomainBlockedEvent(pDisp, startURL, redirectURL, frame, statusCode);
            this.parent.RaiseOnRedirectXDomainBlocked(this.parent, redirectxdomainblockedEvent);
            startURL = redirectxdomainblockedEvent.startURL;
            redirectURL = redirectxdomainblockedEvent.redirectURL;
            frame = redirectxdomainblockedEvent.frame;
            statusCode = redirectxdomainblockedEvent.statusCode;
        }
        
        public virtual void BeforeScriptExecute(object pDispWindow) {
            DWebBrowserEvents2_BeforeScriptExecuteEvent beforescriptexecuteEvent = new DWebBrowserEvents2_BeforeScriptExecuteEvent(pDispWindow);
            this.parent.RaiseOnBeforeScriptExecute(this.parent, beforescriptexecuteEvent);
        }
        
        public virtual void WebWorkerStarted(uint dwUniqueID, string bstrWorkerLabel) {
            DWebBrowserEvents2_WebWorkerStartedEvent webworkerstartedEvent = new DWebBrowserEvents2_WebWorkerStartedEvent(dwUniqueID, bstrWorkerLabel);
            this.parent.RaiseOnWebWorkerStarted(this.parent, webworkerstartedEvent);
        }
        
        public virtual void WebWorkerFinsihed(uint dwUniqueID) {
            DWebBrowserEvents2_WebWorkerFinsihedEvent webworkerfinsihedEvent = new DWebBrowserEvents2_WebWorkerFinsihedEvent(dwUniqueID);
            this.parent.RaiseOnWebWorkerFinsihed(this.parent, webworkerfinsihedEvent);
        }
    }
}
