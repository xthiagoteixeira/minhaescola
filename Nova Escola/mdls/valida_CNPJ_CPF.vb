Public Class valida_CNPJ_CPF
    ...
    Private ReadOnly dadosArray() As String = {"111.111.111-11", "222.222.222-22", "333.333.333-33", "444.444.444-44", _
    ...
    Public Property cnpj() As String
        ...
        Set(ByVal Valor As String)
            ...
            If bValida Then
                sCNPJ = Valor
            Else
                'Throw (New System.ArgumentException(msgErro, "Número do CNPJ"))
                'MsgBox("Número do CNPJ é inválido!", MsgBoxStyle.Information, NomeProjeto)
            End If
        End Set
    End Property
