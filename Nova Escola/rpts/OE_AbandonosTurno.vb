...
Public Class OE_AbandonosTurno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_AbandonosTurno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_AbandonosTurno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_AbandonosTurno = New OE_AbandonosTurno()
        rpt.Site = Me.Site
        Return rpt
    End Function
