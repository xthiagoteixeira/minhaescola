...
Public Class RendimentoNotas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.RendimentoNotas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRendimentoNotas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RendimentoNotas = New RendimentoNotas()
        rpt.Site = Me.Site
        Return rpt
    End Function
