...
Public Class ListaAlunosPiloto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ListaAlunosPiloto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaAlunosPiloto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaAlunosPiloto = New ListaAlunosPiloto()
        rpt.Site = Me.Site
        Return rpt
    End Function
