...
Public Class OE_ProblemasDesempenho
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OE_ProblemasDesempenho.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_ProblemasDesempenho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_ProblemasDesempenho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_ProblemasDesempenho = New OE_ProblemasDesempenho()
        rpt.Site = Me.Site
        Return rpt
    End Function
