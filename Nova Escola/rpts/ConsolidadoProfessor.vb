...
Public Class ConsolidadoProfessor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConsolidadoProfessor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ConsolidadoProfessor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidadoProfessor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidadoProfessor = New ConsolidadoProfessor()
        rpt.Site = Me.Site
        Return rpt
    End Function
