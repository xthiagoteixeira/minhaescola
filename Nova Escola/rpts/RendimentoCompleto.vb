...
Public Class RendimentoCompleto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.RendimentoCompleto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRendimentoCompleto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RendimentoCompleto = New RendimentoCompleto()
        rpt.Site = Me.Site
        Return rpt
    End Function
