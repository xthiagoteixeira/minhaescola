...
Public Class RendimentoFaltas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.RendimentoFaltas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRendimentoFaltas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RendimentoFaltas = New RendimentoFaltas()
        rpt.Site = Me.Site
        Return rpt
    End Function
