...
Public Class OE_Indicadores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_Indicadores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_Indicadores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_Indicadores = New OE_Indicadores()
        rpt.Site = Me.Site
        Return rpt
    End Function
