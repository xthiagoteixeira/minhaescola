...
Public Class OE_StatusAlunos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_StatusAlunos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_StatusAlunos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_StatusAlunos = New OE_StatusAlunos()
        rpt.Site = Me.Site
        Return rpt
    End Function
