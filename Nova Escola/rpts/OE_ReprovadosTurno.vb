...
Public Class OE_ReprovadosTurno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_ReprovadosTurno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_ReprovadosTurno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_ReprovadosTurno = New OE_ReprovadosTurno()
        rpt.Site = Me.Site
        Return rpt
    End Function
