...
Public Class ListaAlunosReuniao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ListaAlunosReuniao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaAlunosReuniao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaAlunosReuniao = New ListaAlunosReuniao()
        rpt.Site = Me.Site
        Return rpt
    End Function
