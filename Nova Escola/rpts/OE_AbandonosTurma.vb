...
Public Class OE_AbandonosTurma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_AbandonosTurma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_AbandonosTurma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_AbandonosTurma = New OE_AbandonosTurma()
        rpt.Site = Me.Site
        Return rpt
    End Function
