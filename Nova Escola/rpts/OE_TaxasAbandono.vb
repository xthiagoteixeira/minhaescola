...
Public Class OE_TaxasAbandono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.OE_TaxasAbandono.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOE_TaxasAbandono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OE_TaxasAbandono = New OE_TaxasAbandono()
        rpt.Site = Me.Site
        Return rpt
    End Function
