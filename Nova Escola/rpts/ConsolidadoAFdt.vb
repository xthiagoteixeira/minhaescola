...
Public Class ConsolidadoAFdt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ConsolidadoAFdt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidadoAFdt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidadoAFdt = New ConsolidadoAFdt()
        rpt.Site = Me.Site
        Return rpt
    End Function
