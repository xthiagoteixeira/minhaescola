...
Public Class ListaAlunosCIAula
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ListaAlunosCIAula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaAlunosCIAula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaAlunosCIAula = New ListaAlunosCIAula()
        rpt.Site = Me.Site
        Return rpt
    End Function
