...
Public Class BoletinsAtraso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.BoletinsAtraso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoletinsAtraso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BoletinsAtraso = New BoletinsAtraso()
        rpt.Site = Me.Site
        Return rpt
    End Function
