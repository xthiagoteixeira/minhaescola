...
Public Class REEvasaoEscolar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.REEvasaoEscolar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREEvasaoEscolar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REEvasaoEscolar = New REEvasaoEscolar()
        rpt.Site = Me.Site
        Return rpt
    End Function
