...
Public Class ataConvencional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ataConvencional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedataConvencional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ataConvencional = New ataConvencional()
        rpt.Site = Me.Site
        Return rpt
    End Function
