...
Public Class GraficosGTurmas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.GraficosGTurmas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGraficosGTurmas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GraficosGTurmas = New GraficosGTurmas()
        rpt.Site = Me.Site
        Return rpt
    End Function
