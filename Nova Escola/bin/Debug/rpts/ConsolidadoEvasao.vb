...
Public Class ConsolidadoEvasao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ConsolidadoEvasao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidadoEvasao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidadoEvasao = New ConsolidadoEvasao()
        rpt.Site = Me.Site
        Return rpt
    End Function
