...
Public Class ListaAlunosReqCon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ListaAlunosReqCon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaAlunosReqCon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaAlunosReqCon = New ListaAlunosReqCon()
        rpt.Site = Me.Site
        Return rpt
    End Function
