...
Public Class ListaEntregaPS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ListaEntregaPS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaEntregaPS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaEntregaPS = New ListaEntregaPS()
        rpt.Site = Me.Site
        Return rpt
    End Function
