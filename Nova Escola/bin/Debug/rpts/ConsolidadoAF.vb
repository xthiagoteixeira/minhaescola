...
Public Class ConsolidadoAF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ConsolidadoAF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidadoAF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidadoAF = New ConsolidadoAF()
        rpt.Site = Me.Site
        Return rpt
    End Function
