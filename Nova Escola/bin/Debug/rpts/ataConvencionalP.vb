...
Public Class ataConvencionalP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mais_Escola.ataConvencionalP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedataConvencionalP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ataConvencionalP = New ataConvencionalP()
        rpt.Site = Me.Site
        Return rpt
    End Function
