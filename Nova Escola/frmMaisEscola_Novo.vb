...
Public Class frmMaisEscola_Novo
    ...
    Private Sub navMaisProfessor_GerenciarUsuarios_LinkClicked(sender As Object, e As NavBarLinkEventArgs) Handles navMaisProfessor_GerenciarUsuarios.LinkClicked
    ...
    Private Sub navMaisProfessor_Publicar_LinkClicked(sender As Object, e As NavBarLinkEventArgs) Handles navMaisProfessor_Publicar.LinkClicked
        Dim fGerencialPublic As New frmBWPublicar() With {.MdiParent = Me}
        fGerencialPublic.Show()
    End Sub
    ...
    Private Sub navMaisProfessor_TrazerNotasOnline_LinkClicked(sender As Object, e As NavBarLinkEventArgs) Handles navMaisProfessor_TrazerNotasOnline.LinkClicked
        Try
            'Procura se tem permissão no servidor...
            Dim Morpheus_Web As New Web
            CodigoEscola = (Morpheus_Web.BW_Ativacao(UsuarioWeb, SenhaWeb))

            If CodigoEscola = "0" Then
                MsgBox("Entre em contato com o suporte para ativação!", MsgBoxStyle.Information, "BoletimWeb!")
            Else
                Dim fTnBoletim As New frmBWTrazer() With {.MdiParent = Me}
                fTnBoletim.Show()
            End If
        Catch ex As Exception
            MsgBox("Entre em contato com o suporte para ativação!", MsgBoxStyle.Information, "BoletimWeb!")
    ...
    Private Sub btTeamviewer_ItemClick(sender As Object, e As ItemClickEventArgs) Handles btTeamviewer.ItemClick
        Try
            ...
            Process.Start(String.Format("{0}\TeamViewerQS.exe", meucaminhorelatorio))
        Catch ex As Exception
