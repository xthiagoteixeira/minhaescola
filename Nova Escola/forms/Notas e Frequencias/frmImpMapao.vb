...
Public Class frmImpMapao
    ...
    Private Sub frmImportacaoBoletins_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim dh As New Helpers.DataHelper(DSparametr.simpleDS)
    ...
    Private Sub bwCarregar_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwCarregar.DoWork
        ...
        While (arrayArquivos(contador) IsNot Nothing)
            ...
            If arrayArquivosTipo(contador) = "Mapão XLS" Then
                ...
                Using leitor As New TextFieldParser(arrayArquivos(contador).ToString)
                    ...
                    While Not leitor.EndOfData
                        ...
                        If NomeTurma = String.Empty Then ' /////////////////////////// Nome da Turma
                            While (NomeTurma = String.Empty)
                                Try
                                    linhaAtual = leitor.ReadFields()
                                    If linhaAtual(31).Contains("Turma:") = True Then
                                        NomeTurma = String.Format("{0}", linhaAtual(31).ToString)
                            ...
                            ' ///////////// BIMESTRE...
                            While (linhaAtual(1).Contains("Diretoria") = False)
                                linhaAtual = leitor.ReadFields()
                            End While

                            Dim BimestreArquivo = linhaAtual(31).ToString
                            If BimestreArquivo.Contains("PRIMEIRO") = True Then
                                BimestreArquivo = "1"
                            ElseIf BimestreArquivo.Contains("SEGUNDO") = True Then
                                BimestreArquivo = "2"
                            ElseIf BimestreArquivo.Contains("TERCEIRO") = True Then
                                BimestreArquivo = "3"
                            ElseIf BimestreArquivo.Contains("QUARTO") = True Then
                                BimestreArquivo = "4"
                            ElseIf BimestreArquivo.Contains("FINAL") = True Then
                            ...
                            ' ... LINHA das Disciplinas...
                            While (linhaAtual(0).ToString <> "ASSINATURA")
                                linhaAtual = leitor.ReadFields()
                            End While
                            linhaAtual = leitor.ReadFields()
                            linhaAtual = leitor.ReadFields()
                        ...
                        For i = 0 To 80 Step 1
                            ...
                            If linhaAtual(i).ToString <> String.Empty Then

                                Dim ProcuraDisciplina = linhaAtual(i).ToString
                        ...
                        While (linhaAtual(1).ToString.Contains("Aulas") = False)

                            nroAluno = linhaAtual(1).ToString
                            Dim lerColuna = 1
                            ...
                            Else
                                ...
                                If (arrayNF3(i) <> "0") Then
                                    ...
                                    Else
                                        ...
                                        SQL = String.Format("UPDATE notasfreq SET qtdadeaulas='{2}', previsaoaulas='{2}', dt_atualizacao='{1}' WHERE cod_nf='{0}';",
                                                                            arrayNF3(i).ToString, Format(Date.Now, "yyyy-MM-dd HH:mm:ss").ToString, arrayBoletim_Aulas(i).ToString)
                                        MySQL_atualiza(SQL)
                                        ...
                                        While (arrayBoletim_M(i, nroAluno) <> Nothing)
                                            ...
                                            If cbEscolhaBimestre.Text.Contains("Final") = False Then
                                                SQL = String.Format("UPDATE boletim SET M='{2}', F='{3}', AC='{5}', S='N', porcentagem='{4}' WHERE cod_boletim='{0}' AND nro_aluno='{1}';",
                                                                                                                arrayNF3(i).ToString, nroAluno, arrayBoletim_M(i, nroAluno).ToString,
                                                                                                                ...
                                                                                                                arrayBoletim_AC(i, nroAluno).ToString)
                                            Else
                                                SQL = String.Format("UPDATE boletim SET M='{2}', F='0', AC='0', S='1', porcentagem='0' WHERE cod_boletim='{0}' AND nro_aluno='{1}';",
                                                                    arrayNF3(i).ToString, nroAluno, arrayBoletim_M(i, nroAluno).ToString)
                                            End If
                                            MySQL_atualiza(SQL)
                                            nroAluno += 1
                ...
                Using leitor As New TextFieldParser(arrayArquivos(contador).ToString, System.Text.Encoding.UTF7)
                    ...
                    While Not leitor.EndOfData
                        ...
                        If NomeTurma = String.Empty Then
                            ...
                            If BimestreArquivo = "PRIMEIRO" Then
                                BimestreArquivo = "1"
                            ElseIf BimestreArquivo = "SEGUNDO" Then
                                BimestreArquivo = "2"
                            ElseIf BimestreArquivo = "TERCEIRO" Then
                                BimestreArquivo = "3"
                            ElseIf BimestreArquivo = "QUARTO" Then
                                BimestreArquivo = "4"
                            ElseIf BimestreArquivo = "FINAL" Then
                                BimestreArquivo = "FINAL"
                            End If
                        ...
                        While (linhaAtual(0).ToString <> "Secretaria")
                                ...
                                If (arrayNF3(i) <> "0") Then
                                    ...
                                    Else
                                        ...
                                        While (arrayBoletim_M(i, nroAluno) <> Nothing)
                                            ...
                                            Else
                                                SQL = String.Format(
                                                        "UPDATE boletim SET M='{2}', F='0', AC='0', S='1', porcentagem='0' WHERE cod_boletim='{0}' AND nro_aluno='{1}';",
                                                        arrayNF3(i).ToString, nroAluno, arrayBoletim_M(i, nroAluno).ToString)
                                            End If
                                            Dim Retorno = MySQL_atualiza(SQL)
                                            '  nroBoletim = arrayNF3(i).ToString
                                            If Retorno = "0" Then
    ...
    Private Sub PictureEdit1_Click(sender As Object, e As EventArgs) Handles PictureEdit1.Click
        ...
        openFD.Filter = "MAPÃO - Excel|*.xltx;*.xls;*.xlsx"
