...
Public Class frmAdmTurma
    ...
    Dim nometurma_clicada = String.Empty

    Public Sub RefreshTurmas()

        Try
            SQL = "SELECT Classe, Periodo, Ensino, Bloqueado, codigo_trma AS Codigo, Bloqueado AS CodigoBloqueado FROM turma ORDER BY Bloqueado, Classe ASC;"
    ...
    Private Sub btCadastrar_Click(sender As Object, e As EventArgs) Handles btCadastrar.Click
        ...
        If Not (tbClasse.Text = String.Empty Or cbPeriodo.Text = String.Empty Or cbEnsino.Text = String.Empty Or cbPeriodo.Text = String.Empty) Then
    ...
    Private Sub RepositoryItemComboBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles RepositoryItemComboBox1.KeyPress
        e.Handled = True
    End Sub
