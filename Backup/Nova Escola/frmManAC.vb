            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N") Then
                ...
                Try
                    ...
                    Try
                        ...
                        SQL3 = "UPDATE " & BD_OK & ".boletim SET M=" & tbMedia.Text & ", F=" & tbFaltas.Text & ", AC=" & tbAC.Text & ", S=" & tbSN.Text & ", porcentagem=" & porcentagem & " WHERE cod_boletim=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
                        ...
                        SQL2 = "UPDATE " & BD_OK & ".codigobarras2 SET descricao='" & cbarras & "' WHERE cod_nf=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
