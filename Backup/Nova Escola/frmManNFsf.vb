...
Public Class frmManNF
    ...
    Private Sub btAdicionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAdicionar.Click
        ...
        Else
            ...
            MsgBox("Deseja iniciar alteração de boletim final - Turma: " & cbTurma.Text & " - Disciplina: " & cbDisciplina.Text & " ?", MsgBoxStyle.YesNo, "Atenção!")
                ...
                Try
                    ...
                    Try
                        ...
                        Try
                            ...
                            Dim fManAlunos As New frmManAlunos
                            ...
                            frmManAlunos.lbDisciplina.Text = Disciplina
                            frmManAlunos.lbTurma.Text = Turma
                            frmManAlunos.lbBoletim.Text = nf
                            frmManAlunos.Show()
    ...
    Private Sub cbDisciplina_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbDisciplina.SelectedIndexChanged
        ...
        Try
            ...
            Try
                ...
                'SQL3 = "SELECT * FROM " & BD_OK & ".notasfreq WHERE disciplina=" & nrodisciplina
