            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N") Then
                ...
                Try
                    ...
                    Try
                        ...
                        SQL3 = "UPDATE " & BD_OK & ".boletim SET M='" & tbMedia.Text & "', S='" & tbSN.Text & "' WHERE cod_boletim='" & lbBoletim.Text & "' AND nro_aluno='" & lbCodigo.Text & "';"
                        ...
                        SQL2 = "UPDATE " & BD_OK & ".boletim SET M='" & tbMedia.Text & "', S='" & tbSN.Text & "' WHERE cod_boletim=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
                        ...
                        myData2.Clear()
                        SQL2 = "UPDATE " & BD_OK & ".codigobarras SET descricao='" & cbarras & "' WHERE cod_nf=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
                        myCommand2.Connection = conn
                        myCommand2.CommandText = SQL2
                        myAdapter2.SelectCommand = myCommand2
                        myAdapter2.Fill(myData2)
                        ...
                        myData4.Clear()
                        SQL4 = "SELECT * FROM " & BD_OK & ".boletim WHERE nro_aluno='" & lbCodigo.Text & "' AND cod_boletim='" & lbBoletim.Text & "'"
