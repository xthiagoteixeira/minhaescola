            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N") Then
                ...
                Try
                    ...
                    Try
                        ...
                        SQL3 = "UPDATE " & BD_OK & ".avaliacaofinal SET M='" & tbMedia.Text & "', S='" & tbSN.Text & "' WHERE cod_nf='" & lbBoletim.Text & "' AND nro_aluno='" & lbCodigo.Text & "';"
    ...
    Private Sub frmManBoletim_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Try
                ...
                Dim sql8
                sql8 = "SELECT * FROM " & BD_OK & ".avaliacaofinal WHERE cod_nf='" & lbBoletim.Text & "' AND nro_aluno=" & lbCodigo.Text & ""
