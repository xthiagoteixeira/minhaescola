                ...
                Try
                    ...
                    Try
                        ...
                        ElseIf tbMedia.Text = "FA" Or tbMedia.Text = "Fa" Or tbMedia.Text = "fa" Then
                            tbMedia.Text = "16"
                        End If
                        SQL5 = "UPDATE " & BD_OK & ".boletim SET F=" & tbFaltas.Text & ", M=" & tbMedia.Text & ", S='" & tbSN.Text & "', porcentagem='" & porcentagem & "' WHERE cod_boletim=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
