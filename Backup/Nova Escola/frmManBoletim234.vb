            ...
            If (tbSN.Text = "S" Or tbSN.Text = "N") Then
                ...
                Try
                    ...
                    Try
                        ...
                        SQL5 = "UPDATE " & BD_OK & ".boletim SET F=" & tbFaltas.Text & ", AC=" & tbAC.Text & ", M=" & tbMedia.Text & ", S='" & tbSN.Text & "', porcentagem=" & porcentagem & " WHERE cod_boletim=" & lbBoletim.Text & " AND nro_aluno=" & lbCodigo.Text
